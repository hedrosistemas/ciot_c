...
typedef struct _Ciot__SocketCfg Ciot__SocketCfg;
typedef struct _Ciot__SocketStatus Ciot__SocketStatus;
typedef struct _Ciot__SocketInfo Ciot__SocketInfo;
typedef struct _Ciot__SocketReq Ciot__SocketReq;
typedef struct _Ciot__SocketData Ciot__SocketData;
