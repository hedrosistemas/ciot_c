...
typedef struct _Ciot__InterfaceInfo Ciot__InterfaceInfo;
...
typedef enum _Ciot__MsgType {
   ...
   */
  CIOT__MSG_TYPE__MSG_TYPE_GET_CONFIG = 3,
  /*
   * Get status message.
   */
  CIOT__MSG_TYPE__MSG_TYPE_GET_STATUS = 4,
  /*
   * Request message.
   */
  CIOT__MSG_TYPE__MSG_TYPE_REQUEST = 5,
  /*
   * Error message.
   */
  CIOT__MSG_TYPE__MSG_TYPE_ERROR = 6,
  /*
   * Event message.
   */
  CIOT__MSG_TYPE__MSG_TYPE_EVENT = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CIOT__MSG_TYPE)
} Ciot__MsgType;
/*
 * Enum representing different interface types.
 */
typedef enum _Ciot__InterfaceType {
  /*
   * Unknown interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_UNKNOWN = 0,
  /*
   * CIOT interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_CIOT = 1,
  /*
   * Storage interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_STORAGE = 2,
  /*
   * System interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_SYSTEM = 3,
  /*
   * UART interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_UART = 4,
  /*
   * USB interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_USB = 5,
  /*
   * TCP interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_TCP = 6,
  /*
   * Ethernet interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_ETH = 7,
  /*
   * WiFi interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_WIFI = 8,
  /*
   * BLE interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_BLE = 9,
  /*
   * BLE SCN interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_BLE_SCN = 10,
  /*
   * GPIO interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_GPIO = 11,
  /*
   * NTP interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_NTP = 127,
  /*
   * OTA interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_OTA = 128,
  /*
   * DFU interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_DFU = 129,
  /*
   * HTTP Client interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_HTTP_CLIENT = 130,
  /*
   * HTTP Server interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_HTTP_SERVER = 131,
  /*
   * MQTT interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_MQTT = 132,
  /*
   * Custom interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_CUSTOM = 133,
  /*
   * Bridge interface type.
   */
  CIOT__INTERFACE_TYPE__IFACE_TYPE_BRIDGE = 134
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CIOT__INTERFACE_TYPE)
} Ciot__InterfaceType;
...
struct  _Ciot__InterfaceInfo
{
   ...
   * Interface type.
   */
  Ciot__InterfaceType type;
};
#define CIOT__INTERFACE_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ciot__interface_info__descriptor) \
    , 0, CIOT__INTERFACE_TYPE__IFACE_TYPE_UNKNOWN }
...
typedef void (*Ciot__InterfaceInfo_Closure)
                 (const Ciot__InterfaceInfo *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    ciot__interface_type__descriptor;
extern const ProtobufCMessageDescriptor ciot__interface_info__descriptor;
