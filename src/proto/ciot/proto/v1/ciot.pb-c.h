...
typedef struct Ciot__CiotCfg Ciot__CiotCfg;
typedef struct Ciot__CiotInfo Ciot__CiotInfo;
typedef struct Ciot__CiotStatus Ciot__CiotStatus;
typedef struct Ciot__CiotReq Ciot__CiotReq;
typedef struct Ciot__CiotData Ciot__CiotData;
...
typedef enum _Ciot__CiotReqType {
  ...
  /*
   * Request to save current interface configuration.
   */
  CIOT__CIOT_REQ_TYPE__CIOT_REQ_TYPE_SAVE_CFG = 1,
  /*
   * Request to create an configuration
   */
  CIOT__CIOT_REQ_TYPE__CIOT_REQ_TYPE_CREATE_CFG = 2,
  /*
   * Request to delete interface configuration.
   */
  CIOT__CIOT_REQ_TYPE__CIOT_REQ_TYPE_DELETE_CFG = 3,
  /*
   * Request to proxy message.
   */
  CIOT__CIOT_REQ_TYPE__CIOT_REQ_TYPE_PROXY_MSG = 4
