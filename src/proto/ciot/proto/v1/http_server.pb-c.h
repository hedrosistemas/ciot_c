...
typedef struct Ciot__HttpServerCfg Ciot__HttpServerCfg;
typedef struct Ciot__HttpServerStatus Ciot__HttpServerStatus;
typedef struct Ciot__HttpServerReq Ciot__HttpServerReq;
typedef struct Ciot__HttpServerData Ciot__HttpServerData;
