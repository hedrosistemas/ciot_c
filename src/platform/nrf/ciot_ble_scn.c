...
ciot_err_t ciot_ble_scn_handle_event(ciot_ble_scn_t self, void *event, void *event_args)
{
	...
	case BLE_GAP_EVT_ADV_REPORT:
		memcpy(iface_status.adv_report.mac, ev->evt.gap_evt.params.adv_report.peer_addr.addr, 6);
		iface_status.adv_report.rssi = ev->evt.gap_evt.params.adv_report.rssi;
