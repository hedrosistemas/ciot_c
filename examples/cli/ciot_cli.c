...
static int default_argc = DEFAULT_ARGC_SYS_INF;
static const char *default_argv[] = DEFAULT_ARGV_SYS_INF;
...
static int ciot_cli_state(int argc, char const *argv[]);
