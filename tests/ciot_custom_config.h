...
#define CIOT_CONFIG_UART_PORT 18

#define CIOT_CONFIG_HTTPS_ADDRESS "http://127.0.0.1:8181"
...
#define CIOT_CONFIG_MQTTC_ID "ciot_integration_test"
#define CIOT_CONFIG_MQTTC_URL "mqtt://test.mosquitto.org"
#define CIOT_CONFIG_MQTTC_PORT 1883
#define CIOT_CONFIG_MQTTC_QOS 0
#define CIOT_CONFIG_MQTTC_TOPIC_B2D "CIOT/D2B/win32"
#define CIOT_CONFIG_MQTTC_TOPIC_D2B "CIOT/B2D/win32"
